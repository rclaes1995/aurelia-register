...
(function(Buffer, process) {
  (function() {
    ...
    ;
    var Kb = n.Promise || nb;
    nb.prototype["catch"] = nb.prototype.gh;
    function A() {
      var a = this;
    ...
    function Kg(a) {
      ...
      Dg(window, "unload", u(this.Mg, this));
    }
    function Lg(a, b) {
      b = F(b);
    ...
    function eh(a, b, c, d) {
      ...
      }, 0) : ("github" === b && (f = 1025), c.ee.window_features = "menubar=yes,modal=yes,alwaysRaised=yeslocation=yes,resizable=yes,scrollbars=yes,status=yes,height=625,width=" + f + ",top=" + ("object" === typeof screen ? .5 * (screen.height - 625) : 0) + ",left=" + ("object" === typeof screen ? .5 * (screen.width - f) : 0), c.ee.relay_url = Jg(a.G.jc), c.ee.requestWithCredential = u(a.tc, a), dh(a, e, "/auth/" + b, c, d));
    }
    function Wg(a) {
    ...
    jh.isAvailable = function() {
      return kh || !lh && "undefined" !== typeof document && null != document.createElement && !("object" === typeof window && window.chrome && window.chrome.extension && !/^chrome/.test(window.location.href)) && !("object" === typeof Windows && "object" === typeof Windows.lh) && !1;
    };
    h = jh.prototype;
    h.Ed = function() {};
    h.cd = function() {
      ...
      if (a.ke && a.Sf && a.Qe.count() < (0 < a.$c.length ? 2 : 1)) {
        ...
        for (var b = a.hd(b),
          ...
          if (1870 >= a.$c[0].lf.length + 30 + c.length) {
            var e = a.$c.shift(),
                c = c + "&seg" + d + "=" + e.Yg + "&ts" + d + "=" + e.hh + "&d" + d + "=" + e.lf;
            d++;
          } else
            break;
        rh(a, b + c, a.se);
    ...
    function Ch(a, b) {
      ...
      b.kh && (c || R("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), d = !0);
      if (d)
        a.fd = [wh];
      else {
        var e = a.fd = [];
    ...
    function Rh(a, b, c, d) {
      ...
      Th(this, 0);
      hf.wb().Gb("visible", this.Ng, this);
      -1 === a.host.indexOf("fblocal") && gf.wb().Gb("online", this.Lg, this);
    }
    var Sh = 0,
        Uh = 0;
    h = Rh.prototype;
    ...
    h.Hf = function() {
      ...
      for (var a = 0; a < this.sa.length; a++) {
        var b = this.sa[a];
        b && "h" in b.Nf && b.Vg && (b.I && b.I("disconnect"), delete this.sa[a], this.Zc--);
      }
      0 === this.Zc && (this.sa = []);
      this.Ud = {};
    ...
    Z.yc.prototype.simpleListen = Z.yc.prototype.dh;
    ...
    X.prototype.onAuth = X.prototype.Hg;
    ...
    X.prototype.offAuth = X.prototype.Gg;
